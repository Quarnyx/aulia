        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="" method="get" class="row g-3">
                    <input type="hidden" name="page" value="laporan-barang-masuk">
                    <div class="col-md-6">
...
<?php if (isset($_GET['dari_tanggal']) && isset($_GET['sampai_tanggal'])) { ?>
    <div class="row">
        <div class="col-12">
            <div class="card">
                <h4 class="text-center mt-3 mb-3"><b>TOKO AULIA</b><br><b>LAPORAN BARANG MASUK</b><br>Periode <?php
                ...
                <div class="card-body">
                    ...
                    <table id="tabel-data" class="table table-bordered table-bordered dt-responsive nowrap">
                        ...
                        <tbody>
                            ...
                            $no = 1;
                            $sql = "SELECT * FROM view_stok_masuk WHERE tanggal BETWEEN '$daritanggal' AND '$sampaitanggal'";
